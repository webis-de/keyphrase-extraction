/*
 * @(#)ScoreFOComparator.java
 * 
 * Description: ScoreFOComparator 
 *  
 * Created:	    2006-01-31
 ...
 * 
 */
public class ScoreFOComparator implements Comparator {
	...
	public int compare(Object hnp1, Object hnp2) {
		double scoreHnp1 = ((HeadNounPhrase) hnp1).getScoreFO();
		double scoreHnp2 = ((HeadNounPhrase) hnp2).getScoreFO();
