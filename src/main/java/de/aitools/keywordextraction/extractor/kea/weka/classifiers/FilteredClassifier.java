...
package de.aitools.keywordextraction.extractor.kea.weka.classifiers;

import java.util.Enumeration;
import java.util.Vector;

import de.aitools.keywordextraction.extractor.kea.weka.core.Attribute;
import de.aitools.keywordextraction.extractor.kea.weka.core.Instance;
import de.aitools.keywordextraction.extractor.kea.weka.core.Instances;
import de.aitools.keywordextraction.extractor.kea.weka.core.Option;
import de.aitools.keywordextraction.extractor.kea.weka.core.OptionHandler;
import de.aitools.keywordextraction.extractor.kea.weka.core.Utils;
import de.aitools.keywordextraction.extractor.kea.weka.filters.Filter;
...
public class FilteredClassifier extends DistributionClassifier
  ...
  /** The classifier */
  protected Classifier m_Classifier = new de.aitools.keywordextraction.extractor.kea.weka.classifiers.NaiveBayesSimple();

  /** The filter */
  protected Filter m_Filter = new de.aitools.keywordextraction.extractor.kea.weka.filters.DiscretizeFilter();

  /** The instance structure of the filtered instances */
  protected Instances m_FilteredInstances;
  
  /**
   * Default constructor specifying NaiveBayesSimple as the classifier and
   * DiscretizeFilter as the filter. Both of these are just placeholders
   * for more useful selections.
   */
  public FilteredClassifier() {

    this(new de.aitools.keywordextraction.extractor.kea.weka.classifiers.NaiveBayesSimple(), 
	 new de.aitools.keywordextraction.extractor.kea.weka.filters.DiscretizeFilter());
  }
  ...
  public static void main(String [] argv) {
    ...
    try {
      System.out.println("Evaluation disabled!");
