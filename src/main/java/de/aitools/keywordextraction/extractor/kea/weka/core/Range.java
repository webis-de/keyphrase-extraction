...
package de.aitools.keywordextraction.extractor.kea.weka.core;
...
public class Range implements Serializable {
  ...
  public String getRanges() {
    ...
    String result = null;
    Enumeration enumeration = m_RangeStrings.elements();
  ...
  public int [] getSelection() {
    ...
    else
    {
      Enumeration enumeration = m_RangeStrings.elements();
      while (enumeration.hasMoreElements()) {
	String currentRange = (String)enumeration.nextElement();
